...
const game = database.filter(function(element,index){ 
...
console.log(newsdatabase.onlythai())const newsdatabase = {
...
console.log(newsdatabase.onlythai())
...
const datafootball = {
  ...
  console.log(datafootball.allteam())
